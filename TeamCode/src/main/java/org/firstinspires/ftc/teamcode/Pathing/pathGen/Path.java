package org.firstinspires.ftc.teamcode.Pathing.pathGen;

import org.firstinspires.ftc.teamcode.Pathing.localization.Pose;
...
public class Path {
    ...
    private double zeroPowerAccelerationMultiplier = 4;
    ...
    private double pathEndVelocityConstraint = 0.1;
    ...
    // This can be custom set for each Path.
    private double pathEndTranslationalConstraint = 0.1;

    // When the robot is at the end of its current Path or PathChain and the heading error goes
    // below this value, then end the Path. This is in radians.
    // This can be custom set for each Path.
    private double pathEndHeadingConstraint = 0.007;

    // When the t-value of the closest point to the robot on the Path is greater than this value,
    // then the Path is considered at its end.
    // This can be custom set for each Path.
    private double pathEndTValueConstraint = 0.995;

    // When the Path is considered at its end parametrically, then the Follower has this many
    // milliseconds to further correct by default.
    // This can be custom set for each Path.
    private double pathEndTimeoutConstraint = 500;
